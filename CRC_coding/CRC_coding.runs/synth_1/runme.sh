...
HD_PWD='C:/Users/bop/Documents/GitHub/FPGA/CRC_coding/CRC_coding.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CRC_coding.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CRC_coding.tcl
