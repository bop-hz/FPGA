...
HD_PWD='C:/Users/bop/Documents/GitHub/FPGA/ROM_test/ROM_test.runs/rom_read_axi_bram_ctrl_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rom_read_axi_bram_ctrl_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rom_read_axi_bram_ctrl_0_0.tcl
