...
HD_PWD='C:/Users/bop/Documents/GitHub/FPGA/simle_start/simle_start.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log simple_led_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source simple_led_wrapper.tcl -notrace
