...
################################################################
# This is a generated script based on design: rom_read
#
...
proc create_root_design { parentCell } {
  ...
  set ROM_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:ROM:1.0 ROM_0 ]

  set_property -dict [ list \
   CONFIG.READ_WRITE_MODE {READ_WRITE} \
 ] [get_bd_intf_pins /ROM_0/BRAM_PORTA]
  ...
  connect_bd_intf_net -intf_net axi_bram_ctrl_0_BRAM_PORTA [get_bd_intf_pins ROM_0/BRAM_PORTA] [get_bd_intf_pins axi_bram_ctrl_0/BRAM_PORTA]
