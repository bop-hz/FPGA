...
HD_PWD='C:/Users/bop/Documents/GitHub/FPGA/ROM_test/ROM_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rom_read_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rom_read_wrapper.tcl
