...
HD_PWD='C:/Users/bop/Documents/GitHub/FPGA/ROM_test/ROM_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rom_read_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rom_read_wrapper.tcl -notrace
