...
HD_PWD='C:/Users/bop/Documents/GitHub/FPGA/simle_start/simle_start.runs/simple_led_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log simple_led_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source simple_led_xbar_0.tcl
